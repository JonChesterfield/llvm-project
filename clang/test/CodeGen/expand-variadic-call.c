...
// RUN: %clang_cc1 -triple x86_64-unknown-linux-gnu -target-cpu x86-64-v4 -std=c23 -O1 -ffreestanding -mllvm -expand-variadics-disable=true -emit-llvm -o - %s | FileCheck %s
