...
; CHECK:   call void @llvm.donothing() [ "ExplicitUse"(ptr addrspace(3) @llvm.amdgcn.kernel.no_clobber_ds_load_stores_x2_preexisting_aa.lds) ], !alias.scope !1, !noalias !4
; CHECK: store i32 1, ptr addrspace(3) @llvm.amdgcn.kernel.no_clobber_ds_load_stores_x2_preexisting_aa.lds, align 16, !tbaa !6, !noalias !11
; CHECK: %val.a = load i32, ptr addrspace(3) %gep.a, align 4, !tbaa !6, !noalias !11
; CHECK: store i32 2, ptr addrspace(3) getelementptr inbounds (%llvm.amdgcn.kernel.no_clobber_ds_load_stores_x2_preexisting_aa.lds.t, ptr addrspace(3) @llvm.amdgcn.kernel.no_clobber_ds_load_stores_x2_preexisting_aa.lds, i32 0, i32 1), align 16, !tbaa !6, !noalias !11
; CHECK: %val.b = load i32, ptr addrspace(3) %gep.b, align 4, !tbaa !6, !noalias !11
...
; CHECK: !6 = !{!7, !8, i64 0}
; CHECK: !7 = !{!"no_clobber_ds_load_stores_x2_preexisting_aa", !8, i64 0}
; CHECK: !8 = !{!"int", !9, i64 0}
; CHECK: !9 = !{!"omnipotent char", !10, i64 0}
; CHECK: !10 = !{!"Simple C++ TBAA"}
; CHECK: !11 = !{}
