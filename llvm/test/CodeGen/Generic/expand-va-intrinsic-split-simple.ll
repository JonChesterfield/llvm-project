; RUN: opt -mtriple=i386-unknown-linux-gnu -S --expand-va-intrinsics --expand-va-intrinsics-abi=false --expand-va-intrinsics-split=true --expand-va-intrinsics-calls=false < %s | FileCheck %s
