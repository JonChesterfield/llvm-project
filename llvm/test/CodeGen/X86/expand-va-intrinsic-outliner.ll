; RUN: opt -mtriple=i386-unknown-linux-gnu -S --expand-va-intrinsics --expand-va-intrinsics-abi=false --expand-va-intrinsics-split=true --expand-va-intrinsics-calls=false < %s | FileCheck %s -check-prefix=X86
; RUN: opt -mtriple=x86_64-unknown-linux-gnu -S --expand-va-intrinsics --expand-va-intrinsics-abi=false --expand-va-intrinsics-split=true --expand-va-intrinsics-calls=false < %s | FileCheck %s -check-prefix=X64
