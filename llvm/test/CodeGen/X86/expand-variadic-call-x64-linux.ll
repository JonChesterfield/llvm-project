...
; CHECK-NEXT:    call void @wrapped(ptr noundef nonnull %cp) #3
...
entry:
  ...
  call void @wrapped(ptr noundef nonnull %cp) #2
...
; CHECK-NEXT:    call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %va) #3
; CHECK-NEXT:    call void @llvm.va_start(ptr nonnull %va)
; CHECK-NEXT:    call void @wrapped(ptr noundef nonnull %va) #3
; CHECK-NEXT:    call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %va) #3
; CHECK-NEXT:    ret void
;
entry:
  %va = alloca [1 x %struct.__va_list_tag], align 16
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %va) #2
  call void @llvm.va_start(ptr nonnull %va)
  call void @wrapped(ptr noundef nonnull %va) #2
  call void @llvm.va_end(ptr %va)
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %va) #2
  ret void
}
...
; CHECK-NEXT:    call void @wrapped(ptr %va_list) #3
; CHECK-NEXT:    ret void
;
entry:
